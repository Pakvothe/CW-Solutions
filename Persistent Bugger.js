...
function persistence(num) {
    ...
    while (num.toString().length !== 1) {
        num = num.toString().split("").reduce((a, b) => a * b); //paso el numero a string, lo divido y lo multiplico (hasta que queda un solo digito)
        i++;
    }
    return i; //retorno la persistencia (la cantidad de veces que tuve que multiplicar)
}